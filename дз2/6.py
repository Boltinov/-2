...
goods = []
while input("хотите добавить новый товар? введите y/n: ") == 'y':
    number = int(input("введите номер товара: "))
    features = {}
    while input("желаете добавить характеристики продукта? введите y/n: ") == 'y':
        feature_key = input("введите название товара: ")
        feature_value = input("введите цену товрара: ")
